...
void FreeBases(mat2D<cv::Mat *>*bases);

void GetBases(mat2D<cv::Mat *>&bases);
void JPEG2spatial(mat2D<int> * coeffs, mat2D<int> * quant_table, mat2D<cv::Mat *>*bases, int q, cv::Mat& spatialImage);
void read_jpeg(std::string path, mat2D<cv::Mat *>*bases, int &QF, cv::Mat &img_jpeg);